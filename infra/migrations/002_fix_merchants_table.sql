-- Migration: Fix merchants table - add missing columns
-- Version: 002
-- Date: 2025-11-07
-- Description: Adds missing columns to existing merchants table

-- ============================================================================
-- 1. ADD MISSING COLUMNS TO MERCHANTS TABLE
-- ============================================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE merchants ADD COLUMN status TEXT NOT NULL DEFAULT 'draft';
  END IF;
END $$;

-- Add onboarding_stage column if missing
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'merchants' AND column_name = 'onboarding_stage'
  ) THEN
    ALTER TABLE merchants ADD COLUMN onboarding_stage TEXT NOT NULL DEFAULT 'initial';
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE merchants ADD COLUMN country TEXT NOT NULL DEFAULT 'MX';
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE merchants ADD COLUMN currency TEXT NOT NULL DEFAULT 'MXN';
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'merchants' AND column_name = 'channel'
  ) THEN
    ALTER TABLE merchants ADD COLUMN channel TEXT NOT NULL DEFAULT 'CARD_NOT_PRESENT';
  END IF;
END $$;
...
-- ============================================================================
-- 2. CREATE USERS_PROFILE TABLE (IF NOT EXISTS)
-- ============================================================================
...
-- ============================================================================
-- 3. CREATE MERCHANT_MEMBERS TABLE (IF NOT EXISTS)
-- ============================================================================
...
-- ============================================================================
-- 4. ADD INDEXES TO MERCHANTS (IF NOT EXISTS)
-- ============================================================================
